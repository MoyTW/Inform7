...
Anyways after it rises, prep the baking sheet by putting some parchment paper on it. Then take out the dough, flour a board and knead it a bit and then shape it into an oval. Stick it on the sheet and cover it with a cloth (or put it back in the oven) and leave for another 45-minutes-ish.[line break]
...
A kitchen sink is here. It is fixed in place.

A washing machine is here. It is fixed in place.

A large L-shaped countertop is here. It is fixed in place.

A small west countertop is here. It is fixed in place.

An medium east countertop is here. It is fixed in place.
...
An instrument cabinet is here. It is fixed in place.
